package com.codetaker.ammusic.ui.activities
            ...
            while (!stopThread) {
                try {
                    ...
                    runOnUiThread {
                        ...
                        binding.currentDuration.text = formatTime(currentPosition.toLong())
                        binding.finalDuration.text = formatTime(duration.toLong())
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
                }
